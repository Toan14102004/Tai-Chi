...
internal enum JSONFiles {
  internal enum Added {
    private static let _document = JSONDocument(path: "added.json")
  ...
  internal enum Gold {
    private static let _document = JSONDocument(path: "gold.json")
    internal static let assets: [String] = _document["assets"]
    internal static let ddd: Int = _document["ddd"]
    internal static let fr: Int = _document["fr"]
    internal static let h: Int = _document["h"]
  ...
  internal enum Scan {
    private static let _document = JSONDocument(path: "scan.json")
    internal static let assets: [String] = _document["assets"]
    internal static let ddd: Int = _document["ddd"]
    internal static let fr: Int = _document["fr"]
    internal static let h: Int = _document["h"]
